...
export const CardTestimonials = () => {
  ...
  return (
    <Box w="sm"  bg={useColorModeValue('gray.100', 'blue.900')} border={'2px solid'} borderColor={'cyan'} position={'relative'} borderRadius={'15px'} display={'flex'}flexDir={'column'} justifyContent={"center"} alignItems={'center'} paddingTop={'3'} paddingBottom={'3'}>
        {/* Avatar */}
